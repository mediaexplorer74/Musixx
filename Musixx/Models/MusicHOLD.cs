    ...
    public class MusicHOLD : IMusicHOLD
    {
        ...
        private async void RetreiveMetadata()
        {
            ...
            catch(Exception e)
            {
                ...
                var dialog = new MessageDialog(Title + Environment.NewLine + e.Message, "Error when extracting metadata");
        ...
        private async void RetreiveMetadataALTERNATIVE()
        {
            ...
            {
                Debug.WriteLine("!! Error when extracting metadata !! : " + e.Message);
                //var dialog = new MessageDialog(Title + Environment.NewLine + e.Message, "Error when extracting metadata");
                //await dialog.ShowAsync();
            }
        }
